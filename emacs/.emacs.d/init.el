...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (counsel-projectile yasnippet-snippets elixir-yasnippets ember-yasnippets zotxt org-ref ivy-bibtex use-package ox-pandoc pandoc-mode minimap dashboard all-the-icons projectile page-break-lines olivetti darkroom dracula-theme restart-emacs magit)))
